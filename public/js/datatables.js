 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/fh-3.1.7/sc-2.0.2/sp-1.1.1
 *
 * Included libraries:
 *   DataTables 1.10.21, FixedHeader 3.1.7, Scroller 2.0.2, SearchPanes 1.1.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.21/fh-3.1.7/sc-2.0.2/sp-1.1.1",
